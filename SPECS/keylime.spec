...
# RHEL-168795 - Fix hardcoded attestation challenge nonce (CVE-2026-6420).
# Backport https://github.com/keylime/keylime/commit/5e1ac3f4d70e55cd72673ead3dcf88259798c33a
Patch: 0020-verifier-Fix-hardcoded-attestation-challenge-nonce.patch
...
* Tue Jun 02 2026 Anderson Toshiyuki Sasaki <ansasaki@redhat.com> - 7.14.1-6
- keylime: Fix hardcoded attestation challenge nonce (CVE-2026-6420)
  [RHEL-168795]
